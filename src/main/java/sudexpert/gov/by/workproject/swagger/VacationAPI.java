...
public interface VacationAPI {
    ...
    @ApiResponses(value = {
            @ApiResponse(responseCode = "200", description = "Vacations retrieved successfully",
                    content = @Content(schema = @Schema(implementation = VacationDTO.class))),
    ...
    @ApiResponses(value = {
            @ApiResponse(responseCode = "200", description = "Vacation retrieved successfully",
                    content = @Content(schema = @Schema(implementation = VacationDTO.class))),
    ...
    VacationDTO getVacationById(@PathVariable("id") Long id);

    @Operation(summary = "Get vacations by worker id")
    @ApiResponses(value = {
            @ApiResponse(responseCode = "200", description = "Vacations retrieved successfully",
                    content = @Content(schema = @Schema(implementation = VacationDTO.class))),
            @ApiResponse(responseCode = "404", description = "Vacations not found",
                    content = @Content(schema = @Schema(implementation = AppError.class))),
            @ApiResponse(responseCode = "500", description = "Internal server error",
                    content = @Content(schema = @Schema(implementation = AppError.class)))
    })
    List<VacationDTO> getVacationsByWorkerId(@PathVariable("workerId") Long workerId);

    @Operation(summary = "Create vacation")
    @ApiResponses(value = {
            @ApiResponse(responseCode = "201", description = "Vacation created successfully",
                    content = @Content(schema = @Schema(implementation = VacationDTO.class))),
    ...
    VacationDTO updateVacation(@PathVariable("id") Long id,
