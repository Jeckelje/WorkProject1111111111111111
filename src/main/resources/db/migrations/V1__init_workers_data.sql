...
VALUES
    ('Иван', 'Иванов', 'Иванович', 'Главный эксперт', 'Отдел ЭКСиТФиЛЭ',
     false, false, false, false, false, false, false, false, '1990-05-20'),

    ('Петр', 'Петров', 'Петрович', 'Начальник отдела', 'Отдел СТТиЭЭ',
     true, true, true, true, true, true, true, true, '1985-07-10'),

    ('Мария', 'Сидорова', 'Алексеевна', 'Эксперт', 'Отдел ЭКСиТФиЛЭ',
     false, false, true, false, false, false, false, false, '1992-12-01'),

    ('Анна', 'Смирнова', 'Сергеевна', 'Эксперт', 'Отдел СТТиЭЭ',
     false, false, false, true, false, false, false, true, '1995-09-14'),

    ('Сергей', 'Кузнецов', 'Васильевич', 'Эксперт-стажёр', 'Отдел ЭКСиТФиЛЭ',
     false, false, false, false, true, false, false, false, '1988-03-03'),

    ('Ольга', 'Морозова', 'Игоревна', 'Эксперт', 'Отдел СТТиЭЭ',
     false, false, false, false, false, true, false, false, '1991-11-25'),

    ('Алексей', 'Волков', 'Степанович', 'Эксперт', 'Отдел ЭКСиТФиЛЭ',
     false, false, false, false, false, false, true, false, '1987-06-15'),

    ('Татьяна', 'Мельникова', 'Андреевна', 'Главный эксперт', 'Отдел СТТиЭЭ',
     false, true, false, false, true, false, false, false, '1993-09-05'),

    ('Николай', 'Федоров', 'Дмитриевич', 'Эксперт', 'Отдел ЭКСиТФиЛЭ',
     false, false, false, false, false, false, false, false, '1989-04-18'),

    ('Елизавета', 'Элинская', 'Макаровна', 'Эксперт', 'Отдел СТТиЭЭ',
     false, false, false, false, false, false, false, false, '1961-07-02'),

    ('Филипп', 'Колвецкий', 'Павлович', 'Эксперт-стажёр', 'Отдел ЭКСиТФиЛЭ',
     false, false, false, false, false, false, false, false, '1977-05-21'),

    ('Елена', 'Громова', 'Александровна', 'Эксперт', 'Отдел СТТиЭЭ',
